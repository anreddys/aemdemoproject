...
import com.aem.demo.core.service.ReadXMLFiles;

@Component(immediate = true, service = ProductSchedular.class)
@Designate(ocd = SlingSchedulerConfiguration.class)
public class ProductSchedular implements Runnable {

	/**
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(ProductSchedular.class);
	
	@Reference
	private ReadXMLFiles readXmlfiles;
	...
	public void run() {
		...
		readXmlfiles.getXMLFiles();
		
		log.info("getXMLfiles Invoked********");
