...
property={
        Constants.SERVICE_DESCRIPTION + "=child nodes iteration Servlet",
        "sling.servlet.methods=" + HttpConstants.METHOD_GET, "sling.servlet.paths=" + "/bin/childnodes"            
})
public class ChildNodesIterationServlet extends SlingSafeMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest req,
       ...
       // resp.getWriter().write("Title = " + resource.adaptTo(ValueMap.class).get("jcr:title"));
    	...
    	try {
    		...
    		resource = req.getResourceResolver().getResource(nodePath);    		
